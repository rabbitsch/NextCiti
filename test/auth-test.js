...
function seedLoginData(firstnamefaker, lastnamefaker, usernamefaker, passwordfaker) {
  return User.hashPassword(passwordfaker)
  .then(hash => {
    return User.create({
...
describe('Auth endpoints', function() {
  const {firstnamefaker, lastnamefaker, usernamefaker, passwordfaker} = generateLoginData();
  ...
  beforeEach(function() {
    return seedLoginData(firstnamefaker, lastnamefaker, usernamefaker, passwordfaker);
  });
