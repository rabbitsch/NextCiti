...
function seedUserData(firstnamefaker, lastnamefaker, usernamefaker, passwordfaker) {
...
describe('/api/users', function() {
  ...
  beforeEach(function() {
    return seedUserData(firstnamefaker, lastnamefaker, usernamefaker, passwordfaker);
  });
